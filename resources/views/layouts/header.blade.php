...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
    <div class="container"><a class="navbar-brand" href="#">Welcome to Activity 5</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            </ul><span class="navbar-text actions"> <a class="login" href="login2">Log In</a><a class="btn btn-light action-button" role="button" href="/">Log Off</a></span>
        </div>
    </div>
</nav>
<script src="../../../../CST-256/resources/assets/js/jquery.min.js"></script>
<script src="../../../../CST-256/resources/assets/bootstrap/js/bootstrap.min.js"></script>
</body>
